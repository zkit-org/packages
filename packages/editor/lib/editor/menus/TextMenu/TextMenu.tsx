  ...
  return (
    ...
    >
      <Toolbar.Wrapper>
        ...
        <Toolbar.Divider/>
        <MemoButton tooltip={i18n("textMenu.bold")} tooltipShortcut={['Mod', 'B']} onClick={commands.onBold}
        ...
        <MemoButton tooltip={i18n("textMenu.code")} tooltipShortcut={['Mod', 'E']} onClick={commands.onCode}
